...
public class MainActivity extends AppCompatActivity implements
    ...
    private static final String mApiUrl = "https://newsapi.org/v2/top-headlines?apiKey=cd1db87dec794c2288c915ba6abeee94&country=in";
    ...
    private void makeGithubSearchQuery() {
        ...
        URL githubSearchUrl = NetworkUtils.buildUrl(mApiUrl);
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                ...
                try {
                    URL githubUrl = new URL("https://newsapi.org/v2/top-headlines?apiKey=cd1db87dec794c2288c915ba6abeee94&country=in");
                    String githubSearchResults = NetworkUtils.getResponseFromHttpUrl(githubUrl).toString();


   /*                 String PaListContent = getContent(githubSearchResults);
                    JSONObject jsonObject = new JSONObject(PaListContent);
                    JSONArray myResponse = jsonObject.getJSONArray("articles");
//JSONArray tsmresponse = (JSONArray) myResponse.get("listTsm");

                    ArrayList<String> list = new ArrayList<String>();

                    for(int i=0; i<myResponse.length(); i++){
                        list.add(myResponse.getJSONObject(i).getString("title"));
                    }

                    System.out.println(list);

                    PARSING THE JSON DATA AND PRINTING IT ; AFTER THIS, SEARCH THROUGH THE DATA AND PRINT THE RESULT
